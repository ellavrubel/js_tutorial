...
// setTimeout() может принимать неограниченное количество аргументов, но все аргументы после 2 попадают в аргументы функции
...
// рекурсивный setTimeout используется для более гибкой настройки повторения функции